...
- [ ] 1. Create CLI argument parser and dispatch skeleton
  - [ ] 1.1 Create `src/cli.ts` with `parseArgs(argv: string[]): CliOptions` pure function and main dispatch logic
  ...
  - [ ]* 1.2 Write property test: extension-based dispatch correctness
    - **Property 1: Extension-based dispatch correctness**
    - **Validates: Requirements 5.1, 5.2**

  - [ ]* 1.3 Write property test: argument parser preserves all flag values
    - **Property 2: Argument parser preserves all flag values**
    - **Validates: Requirements 1.2, 1.3, 2.3, 2.4, 2.5, 2.8, 2.9, 4.3, 4.4**

- [ ] 2. Implement DOCX→MD conversion path
  - [ ] 2.1 Implement `runDocxToMd(inputPath, opts)` in `src/cli.ts`
  ...
  - [ ]* 2.2 Write property test: output path derivation with --output override
    - **Property 3: Output path derivation with --output override**
    - **Validates: Requirements 1.4, 2.7**

  - [ ]* 2.3 Write property test: dual conflict reporting for DOCX→MD
    - **Property 5: Dual conflict reporting for DOCX→MD**
    - **Validates: Requirements 3.3**

- [ ] 3. Implement MD→DOCX conversion path
  - [ ] 3.1 Implement `runMdToDocx(inputPath, opts)` in `src/cli.ts`
  ...
  - [ ]* 3.2 Write property test: conflict detection respects --force
    - **Property 4: Conflict detection respects --force**
    - **Validates: Requirements 3.1, 3.2**

  - [ ]* 3.3 Write property test: author name resolution
...
- [ ] 5. Update setup.sh to build and install CLI
  - [ ] 5.1 Add CLI build step to `setup.sh`
...
- [ ] 6. Add CLI documentation
  - [ ] 6.1 Create `docs/cli.md` with full CLI documentation
  ...
  - [ ] 6.2 Add CLI section to `README.md`
