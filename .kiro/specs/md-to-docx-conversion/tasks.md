...
- [ ] 1. BibTeX parser module
  - [ ] 1.1 Create `src/bibtex-parser.ts` with `parseBibtex()` and `serializeBibtex()` functions
  ...
  - [ ]* 1.2 Write property test for BibTeX round-trip
    - **Property 2: BibTeX parser round-trip**
    - **Validates: Requirements 9.6, 9.7**

  - [ ]* 1.3 Write unit tests for BibTeX parser edge cases
    - Test malformed entries, missing fields, entries with braces in values, zotero custom fields
    - _Requirements: 9.6_

- [ ] 2. LaTeX-to-OMML converter module
  - [ ] 2.1 Create `src/latex-to-omml.ts` with `latexToOmml()` function
  ...
  - [ ]* 2.2 Write property test for LaTeX-to-OMML round-trip
  ...
  - [ ]* 2.3 Write unit tests for LaTeX-to-OMML
...
- [ ] 4. Markdown parsing with custom rules
  - [ ] 4.1 Create Markdown parsing layer in `src/md-to-docx.ts` using markdown-it
  ...
  - [ ]* 4.2 Write property test for Markdown parser round-trip
    - **Property 1: Markdown parser round-trip**
    - **Validates: Requirements 1.1, 1.2, 1.3, 1.4**

- [ ] 5. OOXML generation core
  - [ ] 5.1 Implement OOXML static templates and archive assembly
  ...
  - [ ] 5.2 Implement character formatting run generation
  ...
  - [ ] 5.3 Implement paragraph-level structures
  ...
  - [ ] 5.4 Implement hyperlink generation
  ...
  - [ ] 5.5 Implement table generation
  ...
  - [ ]* 5.6 Write property tests for OOXML generation
...
- [ ] 7. CriticMarkup and comments
  - [ ] 7.1 Implement CriticMarkup track changes (w:ins, w:del, substitutions)
  ...
  - [ ] 7.2 Implement CriticMarkup comments (w:commentRangeStart/End, word/comments.xml)
  ...
  - [ ]* 7.3 Write property tests for CriticMarkup
    - **Property 8: CriticMarkup revision elements**
    - **Property 9: Comment ID consistency**
    - **Validates: Requirements 7.1-7.4, 8.1-8.2, 8.4**

- [ ] 8. Pandoc citations and Zotero field codes
  - [ ] 8.1 Implement citation resolution and Zotero field code reconstruction
  ...
  - [ ] 8.2 Implement math equation generation
    - Inline math `$...$` → `m:oMath` using `latexToOmml()`
    - Display math `$$...$$` → `m:oMathPara` containing `m:oMath`
    - _Requirements: 10.1, 10.2_

  - [ ]* 8.3 Write property test for Zotero field code reconstruction
...
- [ ] 10. Template-based export support
  - [ ] 10.1 Implement template DOCX style extraction
...
- [ ] 11. Wire the `convertMdToDocx()` public API
...
- [ ] 12. VS Code command integration
  - [ ] 12.1 Register submenu and commands in `package.json`
  ...
  - [ ] 12.2 Implement command handlers in `extension.ts`
...
- [ ] 13. Full round-trip property test
  - [ ]* 13.1 Write property test for MD→DOCX→MD round-trip
...
- [ ] 14. Documentation update
  ...
  - [ ] 14.2 Update `README.md` if it references converter limitations
