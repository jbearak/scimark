...
- [x] 1. Add shared image utilities
  - [x] 1.1 Create image utility module with EMU↔pixel conversion, supported format detection, and content type mapping
  ...
  - [x]* 1.2 Write property test: EMU↔pixel conversion roundtrip (Property 1)
  ...
  - [x]* 1.3 Write property test: Supported format filtering (Property 9)
  ...
  - [x] 1.4 Implement intrinsic dimension reader
  ...
  - [x]* 1.5 Write property test: Aspect ratio preservation (Property 6)
  ...
  - [x] 1.6 Standardize warning messages
...
- [x] 2. Implement DOCX→MD image extraction in converter.ts
  - [x] 2.1 Extend relationship parsing to capture image relationships
  ...
  - [x] 2.2 Implement image format metadata extraction
  ...
  - [x]* 2.3 Write property test: Image format metadata serialization roundtrip (Property 11)
  ...
  - [x] 2.4 Add image ContentItem variant and extend extractDocumentContent
  ...
  - [x]* 2.5 Write property test: Filename resolution priority (Property 10)
  ...
  - [x] 2.6 Extend renderInlineRange to emit image Markdown
  ...
  - [x] 2.7 Extend convertDocx to return extracted image binaries
...
- [x] 3. Checkpoint - Verify DOCX→MD extraction
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement MD→DOCX image embedding in md-to-docx.ts
  - [x] 4.1 Implement image attribute parsing for `{width=N height=N}` syntax
  ...
  - [x]* 4.2 Write property test: Image attribute parsing (Property 5)
  ...
  - [x] 4.3 Extend MdRun type and processInlineChildren for images
  ...
  - [x] 4.4 Extend DocxGenState for image tracking
    - Add `imageRelationships`, `imageBinaries`, `imageFormats`, `imageExtensions` fields to `DocxGenState`
    - _Requirements: 2.3, 2.4, 2.5, 2.6_

  - [x] 4.5 Extend generateRuns to emit `<w:drawing>` OOXML for images
  ...
  - [x] 4.6 Extend contentTypesXml and documentRelsXml for images
  ...
  - [x] 4.7 Implement image format metadata writing
  ...
  - [x] 4.8 Wire image embedding into convertMdToDocx pipeline
...
- [x] 5. Checkpoint - Verify MD→DOCX embedding
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Roundtrip integration and property tests
  - [x] 6.1 Wire image placement in document flow
  ...
  - [x]* 6.2 Write property test: Dimension roundtrip (Property 2)
  ...
  - [x]* 6.3 Write property test: Alt text roundtrip (Property 3)
  ...
  - [x]* 6.4 Write property test: Syntax format roundtrip (Property 4)
  ...
  - [x]* 6.5 Write property test: DOCX image structure validity (Property 7)
  ...
  - [x]* 6.6 Write property test: Image deduplication (Property 8)
...
- [x] 7. Checkpoint - Verify roundtrip integration
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Update user-facing documentation
  - [x] 8.1 Add Images section to docs/specification.md
  ...
  - [x] 8.2 Update docs/converter.md
  ...
  - [x] 8.3 Update docs/guides/documentation.md
